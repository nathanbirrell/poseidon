...
class SpotUtil {
  ...
  matchValueToDescription(number, values, descriptions) {
    let output = '';
    if (number) {
  ...
  static windKphToDescription(wind_kph) {
    ...
    this.matchValueToDescription(wind_kph, speeds, descriptions);
  }
  ...
  static swellFeetToDescription(wave_feet) {
    ...
    this.matchValueToDescription(wave_feet, speeds, descriptions);
  }
}
