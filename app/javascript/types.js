export const FETCH_SPOT_LIST_REQUEST = 'FETCH_SPOT_LIST_REQUEST';
export const FETCH_SPOT_LIST_SUCCESS = 'FETCH_SPOT_LIST_SUCCESS';
export const FETCH_SPOT_LIST_ERROR = 'FETCH_SPOT_LIST_ERROR';
